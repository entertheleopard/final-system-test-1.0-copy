  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      ...
      reactions: {
        ...
        '❤️': { emoji: '❤️', count: 14, userReacted: false } // Combined likes + reactions
      },
      replies: [
        {
          id: '1-1',
          ...
          text: '@creative_soul Totally agree!',
          timestamp: '1h',
          reactions: {
            '❤️': { emoji: '❤️', count: 3, userReacted: false }
          },
          replies: []
        }
      ]
    },
    {
      ...
      timestamp: '5h',
      reactions: {
        '❤️': { emoji: '❤️', count: 8, userReacted: true }
      },
      replies: []
    },
    {
      ...
      text: 'Incredible work as always 👏',
      timestamp: '1d',
      reactions: {
        '❤️': { emoji: '❤️', count: 24, userReacted: false },
    ...
    },
    {
      ...
      timestamp: '2d',
      reactions: {
        '❤️': { emoji: '❤️', count: 18, userReacted: true },
